...
CREATE TABLE restaurants (
  ...
  overallAvg DECIMAL(1.3) DEFAULT NULL,
  foodAvg DECIMAL(1.3) DEFAULT NULL,
  serviceAvg DECIMAL(1.3) DEFAULT NULL,
  ambienceAvg DECIMAL(1.3) DEFAULT NULL,
  valueAvg DECIMAL(1.3) DEFAULT NULL,
  wyrAvg DECIMAL(1.3) DEFAULT NULL,
